...
public class HomeFragmentCompany extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.fragment_home_company, container, false);
        //old code
       /* firebaseAuth = FirebaseAuth.getInstance();
        firebaseFirestore = FirebaseFirestore.getInstance();
        postNewsArrayList = new ArrayList<>();
        recyclerView = view.findViewById(R.id.recycler_view_news_id);
        newsAdapterOld = new NewsAdapterOld(getContext(), postNewsArrayList);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext(), LinearLayoutManager.VERTICAL, false));
        recyclerView.setAdapter(newsAdapterOld);
